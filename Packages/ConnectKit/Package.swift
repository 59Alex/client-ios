...
let package = Package(
    ...
    products: [
        ...
        .library(name: "ConnectSettings", targets: ["ConnectSettings"]),
    ...
    targets: [
        ...
        .target(name: "ConnectSettings", dependencies: ["ConnectCore", "ConnectNetworking"]),
        .target(name: "ConnectChat", dependencies: ["ConnectCore", "ConnectNetworking", "ConnectCalls", "ConnectFiles"]),
        .target(name: "ConnectTestSupport", dependencies: ["ConnectCore", "ConnectNetworking", "ConnectCalls", "ConnectChat", "ConnectFiles", "ConnectFeatures", "ConnectInbox", "ConnectRooms", "ConnectSettings"]),
        ...
        .testTarget(name: "ConnectSettingsTests", dependencies: ["ConnectSettings", "ConnectCore", "ConnectFeatures", "ConnectAuth", "ConnectNetworking", "ConnectTestSupport"]),
