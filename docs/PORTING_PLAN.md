...
| Личный звонок: камера, демонстрация экрана, свернуть, «позвонить снова» | там же | 🟡 приём камеры и экрана собеседника на сцене; своя камера и экран, свернуть — ⬜ |
| CallKit и входящие в фоне | — | ⬜ 🖥 VoIP push |
| Групповые звонки: вызов участников, вход в активный, список, речь, камера, экран | `useGroupCall.ts`, `/api/groupcall/*` | 🟡 аудио: вызов, входящий, вход в идущий, участники, речь, mute; приём камер и экранов участников на сцене; своя камера и экран — ⬜ |
