...
enum UITestStub {
    ...
    static func makeChatAPI() -> FakeChatAPI {
        ...
        let messages = [
            ...
            ChatMessage(id: "00000000-0000-4000-8000-000000000006", text: "", createdAtMilliseconds: base - 800_000, authorId: "qa-1", username: "@qa_wallpaper_1", attachments: [ChatAttachment(urlS3: "file-chat@room-qa-2/videocirclemessages/qa/1.mp4", name: "video-message-2026-09-14T09-46-00-000Z", extension: ".mp4")]),
